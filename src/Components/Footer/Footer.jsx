        ...
        <footer className='footer '>
            <div className="footer-box flex-element containerElement">
                ...
                <div className="footer-items">
                    ...
                    <a target="_blank" className='footer-bottom-link default-desc-text text-light flex-element' href='https://api.whatsapp.com/send?phone=971581694135&text=I_want_to_enquire_about%20The%20Best%20Dubai%20Tours%20and%20Things%20to%20Do%20in%202024'><img src={WhatsappIcon} alt="No icon" /> Whatsapp</a>
                </div>
            </div>
        </footer>
    )
