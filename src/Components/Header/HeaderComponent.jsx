  ...
  return (
    <header className='header containerElement mt-5'>
      <div className="header-box">
        ...
        <img className='header-img-one' style={{ marginTop: "100px" }} src="./public/Images/MSR04060.png" alt="No image" />
        ...
        <img className='mt-5' src="./public/Images/image.png" alt="No image" />
      </div>
      <div className="header-banner">
        <img src="/public/Images/headerBannerImage2.png" alt="No image" />
        <img src="/public/Images/headerBannerImage3.png" alt="No image" />
      </div>
      ...
      <div style={{ padding: "" }} className="header-text-section containerElement text-center">
        ...
        <button className="default-desc-text default-button">Read more <img src="./public/Icons/RightIcon.png" alt="No icon" /></button>
      </div>
    </header>
  )
}
