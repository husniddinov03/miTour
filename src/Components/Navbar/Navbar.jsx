    ...
    return (
        <nav className='nav'>
            <div className="nav-box" style={helpCss[1]}>
                ...
                <br />
                <Link className='nav-top-btn default-title-text' to='https://api.whatsapp.com/send?phone=971581694135&text=I_want_to_enquire_about%20The%20Best%20Dubai%20Tours%20and%20Things%20to%20Do%20in%202024'>{t('navbar.topBtn')}</Link>
                <br />
