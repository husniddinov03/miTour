    ...
    return (
        <div className='services containerElement'>
            <div className="servicesTitle flex-element gap-3 mt-5">
                <h1 style={{ fontSize: "34px" }} className='default-title-text pt-5'>Our</h1><TitlePage text="Services" />
            </div>
            <div style={{ display: "flex", marginTop: "80px", gap: "25px", flexWrap: "wrap", }} className="servicesBox ">

                {data.map(datas => (
                    <div id={datas.id} className="services-item" style={{
